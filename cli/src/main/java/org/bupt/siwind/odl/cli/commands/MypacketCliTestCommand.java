 ...
 */
package org.bupt.siwind.odl.cli.commands;
...
public class MypacketCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(MypacketCliTestCommand.class);
    protected final MypacketCliCommands service;

    public MypacketCliTestCommand(final MypacketCliCommands service) {
